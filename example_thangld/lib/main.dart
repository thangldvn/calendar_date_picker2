...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget _buildDefaultRangeDatePickerWithValue() {
    ...
    final config = CalendarDatePicker2Config(
      ...
      lastMonthIcon: SvgPicture.asset("assets/svg/prev_month_ic.svg"),
      nextMonthIcon: SvgPicture.asset("assets/svg/next_month_ic.svg"),
      customCirleTodayWidget: SvgPicture.asset(
        "assets/svg/circle_today.svg",
        fit: BoxFit.cover,
      ),
      weekdayLabels: [
        "Sun",
      ...
      dayTextStylePredicate: ({required date}) {
        if (date.weekday == DateTime.sunday) {
          ...
          return const TextStyle(
              fontSize: 12, fontFamily: "Roboto", fontWeight: FontWeight.w700);
        }
      },
      selectedRangeHighlightColor: Color(0xFFEFFDF7),
      selectedRangeDayTextStyle: TextStyle(
        ...
        foreground: Paint()
          ..shader = const LinearGradient(
            colors: <Color>[Color(0xff006B68), Color(0xff00978C)],
          ).createShader(
            const Rect.fromLTWH(0.0, 0.0, 16.0, 14.0),
          ),
      ),
    );
    return Column(
